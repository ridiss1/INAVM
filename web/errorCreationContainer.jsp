<%-- 
    Document   : errorCreationContainer
    Created on : 4 janv. 2016, 20:12:43
    Author     : Jean
--%>
...
<html>
    ...
    <body>
        ...
        <div id="main">
            ...
            <div align="center">
                <p style="color:red"> <i class="fa fa-exclamation-triangle"></i> An error occurred during the creation of the VM. Please try again. </p>
              <a href="${pageContext.request.contextPath}/FormCreatContenaire"><button type="button" class="btn btn-primary btn-lg">Create a VM</button></a>              
            </div>
